...
//function declaration ===> function expression ==> es6 arrow function (=>)

var calculateDiscount = (totalAmount, discountCode) => {
    switch (discountCode) {
        case 'SAVE10':
        case 'SAVE10DOLLARS': 
        case 'TENOFF':
...
// invoke the function
var result = calculateDiscount(totalAmount, discountCode); // calculate the discount
